...
import { SerializedEditorState } from "./plate-types"
...
export function PlateEditor({
  ...
  onChange?: ({ editor, value }: { editor: TPlateEditor; value: Value }) => void
}) {
  const editor = usePlateEditor({
    plugins: EditorKit,
    value: value ?? defaultEditorValue,
  }) as unknown as TPlateEditor
...
export const defaultEditorValue = normalizeStaticValue([
  {
