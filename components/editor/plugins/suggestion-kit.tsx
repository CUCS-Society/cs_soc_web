...
import type { ExtendConfig, Path, PluginConfig, WithAnyKey } from "platejs"
...
export const suggestionPlugin = toTPlatePlugin<SuggestionConfig>(
  ...
  render: {
    belowNodes: SuggestionLineBreak as RenderNodeWrapper<
      WithAnyKey<PluginConfig<"suggestion">>
    >,
    node: SuggestionLeaf,
  },
})
